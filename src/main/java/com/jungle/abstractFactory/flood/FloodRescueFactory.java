 ...
 * Hãy dùng FloodCriticalFactory / FloodHighFactory / FloodMediumFactory / FloodLowFactory
 * thông qua RescueFactoryProvider.getFactory(type, urgency).
 *
 * Mặc định delegate sang FloodMediumFactory.
 */
@Deprecated
public class FloodRescueFactory implements RescueFactory {
